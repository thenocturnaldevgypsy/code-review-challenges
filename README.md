<h3 align="center">Code Review & Challenges</h3>
<p align="center"><em>My Repo for Tech and Programming Challenges/Playground</em></p>
...
<p align="center">
   ...
   <img src="https://img.shields.io/badge/Lang-Git%20|%20PHP%20|%20Python%20|%20Ruby%20|%20Go-%2300416a?logoColor=white&labelColor=%2300416a&color=%2324292e&textColor=white" alt="Lang-Git|PHP|Python|Ruby|Go">
   ...
   <img src="https://img.shields.io/badge/Last%20Update-10.03.2025-%2300416a?logoColor=white&labelColor=%2300416a&color=%2324292e&textColor=white" alt="Last Update 10.03.2025"><br>
...
In order to provide a steady stream of tech and coding challenges that can help review sharpen my skills in programming, I signed up to some coding challenges portals and created this repo to save my progress/activities.
...
| Portal and PL/Topic | Directory in this Repo (if any) | Track |
| ------------- | ------------- | ------------- |
| [Exercism.org - PHP](https://exercism.org/tracks/php) | Exercism - PHP | 12 of 114 |
| [Exercism.org = Python](https://exercism.org/tracks/python) | Exercism - Python | 3 of 140 |
| [Exercism.org - Go](https://exercism.org/tracks/go) | Exercism - Go | 1 of 141 |
| [Exercism.org - Ruby](https://exercism.org/tracks/ruby) | Exercism - Ruby | 1 of 120 |
| [codecademy.com - Code Foundations](https://www.codecademy.com/learn/paths/code-foundations) | --- | Courses Done: 4<br>Lessons Only: 1 |
| [Epic Web - Git Fundamentals](https://www.epicweb.dev/tutorials/git-fundamentals) | Epic Web - Git  | 17 of 17 |
...
| Portal | Profile Link |
| ------------- | ------------- |
| Exercism | https://exercism.org/profiles/thenocturnaldevgypsy |
...
See the [open issues](https://github.com/thenocturnaldevgypsy/code-review-challenges/issues) and [backlog](https://github.com/thenocturnaldevgypsy/code-review-challenges/milestones) for the list of challenges tracks and repo features (and known issues).
